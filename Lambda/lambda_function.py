...
def lambda_handler(request, context):
	...
	if namespace == 'Alexa.PowerController':
		...
		# Example : { room-light-power : True }
		update_thing_shadow( endpoint_id + '-power', False if power_state_value == 'OFF' else True)
...
def update_thing_shadow(name, value) :
	...
	topic_shadow_name = '$aws/things/' + thing_name + '/shadow/update'
	client.publish(
